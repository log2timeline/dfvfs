...
class TSKPartitionResolverHelperTest(test_lib.ResolverHelperTestCase):
    ...
    def testNewFileObject(self):
        ...
        self._TestNewFileObject(resolver_helper_object, test_tsk_partition_path_spec)
    ...
    def testNewFileSystem(self):
        ...
        self._TestNewFileSystem(resolver_helper_object, test_tsk_partition_path_spec)
