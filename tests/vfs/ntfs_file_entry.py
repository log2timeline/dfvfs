...
class NTFSFileEntryTest(shared_test_lib.BaseTestCase):
    ...
    def setUp(self):
        ...
        self._ntfs_path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_NTFS, location="\\", parent=self._raw_path_spec
        )
    ...
    def testGetStatAttribute(self):
        ...
        path_spec = path_spec_factory.Factory.NewPathSpec(
            ...
            mft_entry=self._MFT_ENTRY_A_FILE,
            parent=self._raw_path_spec,
        )
        file_entry = self._file_system.GetFileEntryByPathSpec(path_spec)
        self.assertIsNotNone(file_entry)
    ...
    def testAttributes(self):
        ...
        date_time_string = attribute.modification_time.CopyToDateTimeStringISO8601()
        ...
        date_time_string = attribute.access_time.CopyToDateTimeStringISO8601()
    ...
    def testDataStream(self):
        ...
        path_spec = path_spec_factory.Factory.NewPathSpec(
            ...
            mft_entry=self._MFT_ENTRY_A_DIRECTORY,
            parent=self._raw_path_spec,
        )
        file_entry = self._file_system.GetFileEntryByPathSpec(path_spec)
        self.assertIsNotNone(file_entry)
