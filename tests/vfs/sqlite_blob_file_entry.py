...
class SQLiteBlobFileEntryTest(shared_test_lib.BaseTestCase):
    ...
    def setUp(self):
        ...
        self._sqlite_blob_path_spec_directory = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_SQLITE_BLOB,
            column_name="blobs",
            parent=test_os_path_spec,
            table_name="myblobs",
    ...
    def testIntialize(self):
        ...
        file_entry = sqlite_blob_file_entry.SQLiteBlobFileEntry(
            self._resolver_context, self._file_system, self._sqlite_blob_path_spec_2
        )
    ...
    def testName(self):
        ...
        self.assertTrue(file_entry.name == ("WHERE name == 'mmssms.db'"))
    ...
    def testSubFileEntries(self):
        ...
        expected_sub_file_entry_names = ["OFFSET 0", "OFFSET 1", "OFFSET 2", "OFFSET 3"]
        ...
        self.assertEqual(sorted(sub_file_entry_names), expected_sub_file_entry_names)
