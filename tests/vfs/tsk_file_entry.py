...
class TSKFileEntryTestExt2(shared_test_lib.BaseTestCase):
    ...
    def setUp(self):
        ...
        self._tsk_path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_TSK, location="/", parent=self._raw_path_spec
        )
...
class TSKFileEntryTestISO9660(shared_test_lib.BaseTestCase):
    ...
    def setUp(self):
        ...
        self._tsk_path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_TSK, location="/", parent=self.test_os_path_spec
        )
...
class TSKFileEntryTestNTFS(shared_test_lib.BaseTestCase):
    ...
    def testGetAttributes(self):
        ...
        self.assertEqual(test_attribute.attribute_type, pytsk3.TSK_FS_ATTR_TYPE_NTFS_SI)
    ...
    def testDataStream(self):
        ...
        path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_TSK,
            inode=self._MFT_ENTRY_A_DIRECTORY,
            location="/a_directory",
            parent=self._raw_path_spec,
        )
        file_entry = self._file_system.GetFileEntryByPathSpec(path_spec)
