...
class AESEncryptedStreamWithKeyChainTest(test_lib.PaddedSyslogTestCase):
    ...
    def setUp(self):
        ...
        resolver.Resolver.key_chain.SetCredential(
            self._encrypted_stream_path_spec, "initialization_vector", self._AES_IV
        )
        resolver.Resolver.key_chain.SetCredential(
...
class BlowfishEncryptedStreamWithKeyChainTest(test_lib.PaddedSyslogTestCase):
    ...
    def setUp(self):
        ...
        resolver.Resolver.key_chain.SetCredential(
            self._encrypted_stream_path_spec, "initialization_vector", self._BLOWFISH_IV
        )
        resolver.Resolver.key_chain.SetCredential(
...
class DES3EncryptedStreamWithKeyChainTest(test_lib.PaddedSyslogTestCase):
    ...
    def setUp(self):
        ...
        resolver.Resolver.key_chain.SetCredential(
            self._encrypted_stream_path_spec, "initialization_vector", self._DES3_IV
        )
        resolver.Resolver.key_chain.SetCredential(
