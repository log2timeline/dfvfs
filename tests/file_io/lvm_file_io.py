...
class LVMFileTest(shared_test_lib.BaseTestCase):
    ...
    def testOpenClose(self):
        ...
        path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_LVM, parent=self._raw_path_spec, volume_index=0
        )
        ...
        path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_LVM, parent=self._raw_path_spec, volume_index=9
        )
        file_object = lvm_file_io.LVMFile(self._resolver_context, path_spec)
        ...
        path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_LVM, location="/lvm1", parent=self._raw_path_spec
        )
        file_object = lvm_file_io.LVMFile(self._resolver_context, path_spec)
        ...
        path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_LVM, location="/lvm0", parent=self._raw_path_spec
        )
        file_object = lvm_file_io.LVMFile(self._resolver_context, path_spec)
        ...
        path_spec = path_spec_factory.Factory.NewPathSpec(
            definitions.TYPE_INDICATOR_LVM, location="/lvm9", parent=self._raw_path_spec
        )
        file_object = lvm_file_io.LVMFile(self._resolver_context, path_spec)
    ...
    def testRead(self):
        ...
        expected_data = b"This is a text file.\n\nWe should be able to parse it.\n"
