...
class FileObjectInputReaderTest(shared_test_lib.BaseTestCase):
    ...
    def testReadAscii(self):
        ...
        input_reader = command_line.FileObjectInputReader(file_object, encoding="ascii")
...
class CLIVolumeScannerMediatorTest(shared_test_lib.BaseTestCase):
    ...
    def testPrintLVMVolumeIdentifiersOverview(self):
        ...
        test_mediator._PrintLVMVolumeIdentifiersOverview(volume_system, ["lvm1"])
    ...
    def testPrintPartitionIdentifiersOverviewGPT(self):
        ...
        test_mediator._PrintPartitionIdentifiersOverview(volume_system, ["p1", "p2"])
    ...
    def testPrintPartitionIdentifiersOverviewGPTNonSequential(self):
        ...
        test_mediator._PrintPartitionIdentifiersOverview(volume_system, ["p1", "p3"])
    ...
    def testPrintPartitionIdentifiersOverviewTSK(self):
        ...
        test_mediator._PrintPartitionIdentifiersOverview(volume_system, ["p1", "p5"])
    ...
    def testReadSelectedVolumesGPT(self):
        ...
        selected_volumes = test_mediator._ReadSelectedVolumes(volume_system, prefix="p")
