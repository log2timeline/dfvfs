...
class SourceScannerTest(shared_test_lib.BaseTestCase):
    ...
    def testScanOnAPM(self):
        ...
        scan_node = scan_node.sub_nodes[0]
        self.assertIsNotNone(scan_node)
        self.assertEqual(scan_node.type_indicator, definitions.PREFERRED_APM_BACK_END)
        ...
        scan_node = scan_node.GetSubNodeByLocation("/")
        self.assertIsNotNone(scan_node)
        self.assertEqual(scan_node.type_indicator, definitions.PREFERRED_HFS_BACK_END)
    ...
    def testScanOnVSS(self):
        ...
        self.assertEqual(scan_node.type_indicator, definitions.TYPE_INDICATOR_VSHADOW)
        self.assertEqual(len(scan_node.sub_nodes), 2)
    ...
    def testScanOnDirectory(self):
        ...
        self._source_scanner.Scan(scan_context)
        self.assertEqual(scan_context.source_type, definitions.SOURCE_TYPE_DIRECTORY)
