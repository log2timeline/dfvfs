...
class EncryptedStreamPathSpecTest(test_lib.PathSpecTestCase):
    ...
    def testComparable(self):
        ...
        expected_comparable = "\n".join(
            ["type: TEST", "type: ENCRYPTED_STREAM, encryption_method: test", ""]
        )
        ...
        expected_comparable = "\n".join(
            [
                "type: TEST",
                (
                    "type: ENCRYPTED_STREAM, cipher_mode: cbc, encryption_method: "
                    "test, initialization_vector: 546869732069732049562e, key: "
                    "54686973206973206b65792e"
                ),
                "",
            ]
        )
