...
class HFSPathSpecTest(test_lib.PathSpecTestCase):
    ...
    def testInitialize(self):
        ...
        path_spec = hfs_path_spec.HFSPathSpec(location="/test", parent=self._path_spec)
    ...
    def testComparable(self):
        ...
        expected_comparable = "\n".join(
            ["type: TEST", "type: HFS, location: /test", ""]
        )
        ...
        expected_comparable = "\n".join(
            ["type: TEST", "type: HFS, data stream: test, location: /test", ""]
        )
        ...
        expected_comparable = "\n".join(["type: TEST", "type: HFS, identifier: 1", ""])
        ...
        expected_comparable = "\n".join(
            ["type: TEST", "type: HFS, identifier: 1, location: /test", ""]
        )
