...
class VShadowPathSpecTest(test_lib.PathSpecTestCase):
    ...
    def testInitialize(self):
        ...
        with self.assertRaises(ValueError):
            vshadow_path_spec.VShadowPathSpec(parent=self._path_spec, bogus="BOGUS")
    ...
    def testComparable(self):
        ...
        expected_comparable = "\n".join(
            ["type: TEST", "type: VSHADOW, location: /vss2", ""]
        )
        ...
        expected_comparable = "\n".join(
            ["type: TEST", "type: VSHADOW, store index: 1", ""]
        )
        ...
        expected_comparable = "\n".join(
            ["type: TEST", "type: VSHADOW, location: /vss2, store index: 1", ""]
        )
