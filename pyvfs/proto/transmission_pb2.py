...
_PATHSPEC_TSKFSATTRTYPE = descriptor.EnumDescriptor(
  ...
  values=[
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_HFS_COMP_REC', index=1, number=4355,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_HFS_DATA', index=2, number=4352,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_HFS_EXT_ATTR', index=3, number=4354,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_HFS_RSRC', index=4, number=4353,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NOT_FOUND', index=5, number=0,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_UNIX_EXTENT', index=6, number=4098,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_SI', index=7, number=16,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_ATTRLIST', index=8, number=32,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_FNAME', index=9, number=48,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_VVER', index=10, number=64,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_SEC', index=11, number=80,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_VNAME', index=12, number=96,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_VINFO', index=13, number=112,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_DATA', index=14, number=128,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_IDXROOT', index=15, number=144,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_IDXALLOC', index=16, number=160,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_BITMAP', index=17, number=176,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_SYMLNK', index=18, number=192,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_EAINFO', index=19, number=208,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_EA', index=20, number=224,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_PROP', index=21, number=240,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_NTFS_LOG', index=22, number=256,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='TSK_FS_ATTR_TYPE_UNIX_INDIR', index=23, number=4097,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_PATHSPEC = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='attribute_type', full_name='transmission.PathSpec.attribute_type', index=9,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='attribute_id', full_name='transmission.PathSpec.attribute_id', index=10,
...
_PATHSPEC.fields_by_name['attribute_type'].enum_type = _PATHSPEC_TSKFSATTRTYPE
