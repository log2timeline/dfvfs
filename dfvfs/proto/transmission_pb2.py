...
_ROWCONDITION = descriptor.Descriptor(
  name='RowCondition',
...
class RowCondition(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
