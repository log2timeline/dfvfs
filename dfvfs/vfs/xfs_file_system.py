...
class XFSFileSystem(file_system.FileSystem):
    ...
    def GetFileEntryByPathSpec(self, path_spec):
        ...
        if location == self.LOCATION_ROOT or inode == self._root_directory_inode_number:
        ...
        return xfs_file_entry.XFSFileEntry(
            self._resolver_context, self, path_spec, fsxfs_file_entry=fsxfs_file_entry
        )
    ...
    def GetXFSFileEntryByPathSpec(self, path_spec):
        ...
        if inode is not None:
            ...
            raise errors.PathSpecError("Path specification missing location and inode.")
