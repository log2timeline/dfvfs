...
class CPIOArchiveFile(object):
  ...
  _CPIO_BINARY_BIG_ENDIAN_FILE_ENTRY_STRUCT = construct.Struct(
      'signature' / construct.Int16ub,
      'device_number' / construct.Int16ub,
      'inode_number' / construct.Int16ub,
      'mode' / construct.Int16ub,
      'user_identifier' / construct.Int16ub,
      'group_identifier' / construct.Int16ub,
      'number_of_links' / construct.Int16ub,
      'special_device_number' / construct.Int16ub,
      'modification_time_upper' / construct.Int16ub,
      'modification_time_lower' / construct.Int16ub,
      'path_string_size' / construct.Int16ub,
      'file_size_upper' / construct.Int16ub,
      'file_size_lower' / construct.Int16ub)

  _CPIO_BINARY_LITTLE_ENDIAN_FILE_ENTRY_STRUCT = construct.Struct(
      'signature' / construct.Int16ul,
      'device_number' / construct.Int16ul,
      'inode_number' / construct.Int16ul,
      'mode' / construct.Int16ul,
      'user_identifier' / construct.Int16ul,
      'group_identifier' / construct.Int16ul,
      'number_of_links' / construct.Int16ul,
      'special_device_number' / construct.Int16ul,
      'modification_time_upper' / construct.Int16ul,
      'modification_time_lower' / construct.Int16ul,
      'path_string_size' / construct.Int16ul,
      'file_size_upper' / construct.Int16ul,
      'file_size_lower' / construct.Int16ul)

  _CPIO_PORTABLE_ASCII_FILE_ENTRY_STRUCT = construct.Struct(
      'signature' / construct.Bytes(6),
      'device_number' / construct.Bytes(6),
      'inode_number' / construct.Bytes(6),
      'mode' / construct.Bytes(6),
      'user_identifier' / construct.Bytes(6),
      'group_identifier' / construct.Bytes(6),
      'number_of_links' / construct.Bytes(6),
      'special_device_number' / construct.Bytes(6),
      'modification_time' / construct.Bytes(11),
      'path_string_size' / construct.Bytes(6),
      'file_size' / construct.Bytes(11))

  _CPIO_NEW_ASCII_FILE_ENTRY_STRUCT = construct.Struct(
      'signature' / construct.Bytes(6),
      'inode_number' / construct.Bytes(8),
      'mode' / construct.Bytes(8),
      'user_identifier' / construct.Bytes(8),
      'group_identifier' / construct.Bytes(8),
      'number_of_links' / construct.Bytes(8),
      'modification_time' / construct.Bytes(8),
      'file_size' / construct.Bytes(8),
      'device_major_number' / construct.Bytes(8),
      'device_minor_number' / construct.Bytes(8),
      'special_device_major_number' / construct.Bytes(8),
      'special_device_minor_number' / construct.Bytes(8),
      'path_string_size' / construct.Bytes(8),
      'checksum' / construct.Bytes(8))
