...
class CLIVolumeScannerMediator(volume_scanner.VolumeScannerMediator):
    ...
    def _PrintAPFSVolumeIdentifiersOverview(self, volume_system, volume_identifiers):
        ...
        for volume_identifier in sorted(
            volume_identifiers,
            key=lambda string: int(
    ...
    def _PrintPartitionIdentifiersOverview(self, volume_system, volume_identifiers):
    ...
    def GetAPFSVolumeIdentifiers(self, volume_system, volume_identifiers):
        ...
        while True:
            ...
            try:
                ...
                if not selected_volumes or not set(selected_volumes).difference(
                    volume_identifiers
                ):
                    break
            except ValueError:
        ...
        while not result:
            ...
            if input_line in credentials_list:
                ...
                try:
                    ...
                    self._output_writer.Write(
                        f"Unsupported credential: {input_line:s}\n"
                    )
                    continue
