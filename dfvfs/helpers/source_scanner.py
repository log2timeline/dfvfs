...
class SourceScannerContext:
    ...
    SOURCE_TYPE_STORAGE_MEDIA_DEVICE = definitions.SOURCE_TYPE_STORAGE_MEDIA_DEVICE
    SOURCE_TYPE_STORAGE_MEDIA_IMAGE = definitions.SOURCE_TYPE_STORAGE_MEDIA_IMAGE
...
class SourceScanner:
        ...
        while True:
            ...
            if scan_node.IsVolumeSystemRoot():
                ...
                if (
                    ...
                    and not scan_node.sub_nodes
                ):
                    source_path_spec = path_spec_factory.Factory.NewPathSpec(
                        definitions.PREFERRED_MBR_BACK_END,
                        location="/",
    ...
    def ScanForFileSystem(self, source_path_spec):
        ...
        if source_path_spec.type_indicator == (
            ...
            return path_spec_factory.Factory.NewPathSpec(
                definitions.TYPE_INDICATOR_APFS, location="/", parent=source_path_spec
            )
    ...
    def ScanForVolumeSystem(self, source_path_spec):
        ...
        return path_spec_factory.Factory.NewPathSpec(
            type_indicator, parent=source_path_spec
        )

    def Unlock(self, scan_context, path_spec, credential_identifier, credential_data):
