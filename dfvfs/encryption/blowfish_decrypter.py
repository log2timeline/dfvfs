...
class BlowfishDecrypter(decrypter.Decrypter):
    ...
    _ENCRYPTION_MODES = frozenset(
        [definitions.ENCRYPTION_MODE_CBC, definitions.ENCRYPTION_MODE_ECB]
    )
    ...
    def __init__(
        ...
        self._blowfish_context.set_key(key)
    ...
    def Decrypt(self, encrypted_data, finalize=False):
        ...
        if self._cipher_mode == definitions.ENCRYPTION_MODE_CBC:
            decrypted_data = pyfcrypto.crypt_blowfish_cbc(
                self._blowfish_context,
                pyfcrypto.crypt_modes.DECRYPT,
            ...
            decrypted_data = pyfcrypto.crypt_blowfish_ecb(
                self._blowfish_context, pyfcrypto.crypt_modes.DECRYPT, encrypted_data
            )
