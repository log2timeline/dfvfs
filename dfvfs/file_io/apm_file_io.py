# -*- coding: utf-8 -*-
"""The Apple Partition Map (APM) file-like object implementation."""
...
class APMFile(file_io.FileIO):
  """File input/output (IO) object using pyvsapm."""
  ...
  def _Open(self, mode='rb'):
    ...
    """
    entry_index = apm_helper.APMPathSpecGetEntryIndex(self._path_spec)
    ...
    # the vsapm_partition read and seek methods.
